...
| [QUALITY-GATES-SPECIFICATION.md](./QUALITY-GATES-SPECIFICATION.md) | 3-layer quality gates system (Go tooling) | ✅ Current | 2.1.0 |
...
| [EXECUTOR-DECISION-TREE.md](./EXECUTOR-DECISION-TREE.md) | Human/Worker/Agent/Clone routing | ✅ Current | 1.0.0 |
...
| Document | Description | Status | Version |
|----------|-------------|--------|---------|
| [BIFROST-PROJECT-CONTEXT.md](./BIFROST-PROJECT-CONTEXT.md) | **Bifrost Go project — architecture, API, commands, agent guidance** | ✅ Current | 1.0.0 |
...
| 2026-04-03 | 2.2.0 | Translated all Portuguese content to English; renamed Portuguese schema fields to English (executor_type, Input, Output, required, validation, persisted, destination, source, field, type, default); updated quality gates to Go tooling (gofmt, go vet, go test, go build); updated project map to bifrost Go structure; added BIFROST-PROJECT-CONTEXT.md | @dev (Dex) |
