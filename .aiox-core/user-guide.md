...
1. **Briefing and Analysis** - Work with the **analyst** para criar o briefing inicial
...
4. **Design UX** (optional) - Work with **ux-expert** for user experience

### Fase 2: Desenvolvimento (IDE)


1. **Fragmentação de Histórias** - Use o **sm** (Scrum Master) para criar histórias de desenvolvimento
2. **Implementação** - Work with the **dev** para codificar as features
3. **Garantia de Qualidade** - Use o **qa** para testes e validation
...
O **pm** (Product Manager) is responsible for:
...
O agente **dev** is responsible for implementação:
...
**Semana 1**: Work with planejamento
...
2. Execute `*pre-push`
3. Follow the quality gate workflow
...
4. Biblioteca de validation de formulário? (Yup, Zod, Joi, custom)
...
3. HTTP Client: Axios
4. Validation de Formulário: Yup
...
✅ **Faça**:
- Work one story at a time, from start to finish
...
- Follow the patterns defined in the Architecture

❌ **Evite**:
- Começar múltiplas stories simultaneamente
- Pular testes ou validation de QA
...
2. Work with pm and architect para resolver
...
[Follow the interactive elicitation:]
