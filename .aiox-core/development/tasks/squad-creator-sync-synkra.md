...
version: 1.0.0
Input: |
  - squad_path: Caminho do squad para sincronizar (required)
...
| `Validation failed` | Squad não passa na validation | Execute `*validate-squad` primeiro |
