...
const validationRules = [
  ...
  },
  {
    ...
    check: (content) => {
      return content.includes('task:') && 
             ...
             content.includes('executor_type:') &&
             content.includes('atomic_layer:');
    },
    message: 'Task Definition incomplete (missing task, responsible, executor_type, or atomic_layer)',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    check: (content) => {
      ...
      const hasValidation = content.includes('validation:') || content.includes('validation:');
      return hasType && hasBlocker && hasValidation;
    },
    message: 'Checklist items missing required fields (tipo, blocker, validation)',
  },
  {
    id: 6,
