...
function analyzeMissingSections(content) {
  const checks = {
    ...
    taskDefinition: !(content.includes('responsible:') && content.includes('atomic_layer:')),
    entrada: !content.includes('**Input:**'),
    saida: !content.includes('**Output:**'),
